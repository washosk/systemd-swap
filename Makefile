...
# ======================================================================
install-script: ## Generate standalone install script
	@echo "📝 Generating standalone install script..."
	mkdir -p $(OUTPUTDIR)
	cat > $(OUTPUTDIR)/install-standalone.sh <<'INSTALL_EOF'
#!/bin/bash
...
echo "📦 Installing systemd-swap $(PKG_VERSION)..."
...
INSTALL_EOF
	...
	@echo "✅ Install script created: $(OUTPUTDIR)/install-standalone.sh"
